...
project = "I/O Collection"
author = importlib.metadata.metadata("io-collection")["Author"]
copyright = f"{datetime.now().year}, {author}, Allen Institute for Cell Science"
release = importlib.metadata.version("io-collection")
